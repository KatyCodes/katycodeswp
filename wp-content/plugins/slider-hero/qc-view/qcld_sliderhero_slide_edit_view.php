    ...
    <div class="qchero_slider_view_wrapper">
        <div id="qchero_slider_view">
            <div class="add_slide_container">
                <a id="add_image"><span><?php _e( 'Add Slide', 'qchero' ); ?></span><span style="margin-top: 10px;"><i style="color:#000" class="fa fa-plus"
        ...
        <div id="qchero_slider_edit">
			...
			<div class="sliderhero_menu_title effect_title" style="margin-left: 1.5%;margin-bottom: 10px;width: 95.3%;margin-top: 7px;">
				...
				<div class="right_form_effect">
						...
						<input class="effect_change_button" type="Submit" value="Change & Save[PRO]" name="submit" />
            ...
            <div class="settings">
			    ...
			    <div class="menu">
                    ...
                    <ul>
                        ...
                        <li rel="audio-setting"><a href="#" class="">Audio Settings <span style="color: #a3b0e4;font-size: 10px;display: inline-block;position: relative;top: -7px;left: -2px;">[PRO]</span></a></li>
                        <li rel="Effect-setting"><a href="#" class="">Effect Settings <span style="color: #a3b0e4;font-size: 10px;display: inline-block;position: relative;top: -7px;left: -2px;">[PRO]</span></a></li>
                        <li rel="arrows"><a href="#" class="">Arrows <span style="color: #a3b0e4;font-size: 10px;display: inline-block;position: relative;top: -7px;left: -2px;">[PRO]</span></a></li>
...
<span style="    color: #000;
    ...
    margin-left: 20px;padding: 10px 0px;">Auto:</span> <input class="myElements" name="style[fullwidth]" style="display: inline-block;width: 13px;height: 16px;margin: 0px;float: none;" type="radio" value="3" <?php 
							...
							<div class="othersetting">
									...
									<div class="params deseffect customitemstyle">
										<label class="customlevel" for="qchero-effect-interval"><?php _e('Slide Padding Time', 'qchero'); ?> <span class="hero_pro_features">[PRO]</span></label>
										<input class="myElements" style="width: 96%;" type="number" value="" disabled>
									</div>
						...
						<li class="display-setting">
							...
							<div style="clear:both"></div>
							<p style="color:red;font-size: 15px;margin: 10px 0px;">* Please note that some effects are not Transparent and do <b>NOT</b> support slider background Color, Image, Gradient or Video!</p>
							...
							<div class="othersetting" style="display: inline-block; float: left; width: 25%;<?php echo (isset($params->video)&& $params->video!=''?'display:block;':'display:none;'); ?>;" id="sh_video_loop">
								<div class="params customitemstyle" style="width:100%;">
									...
									<select name="params[video_loop]" id="video_loop" class="myElements" disabled>
										<option value="">None</option>
							...
							<div class="othersetting">
								...
								<div class="params customitemstyle" >
									<label class="customlevel" for="qchero-caption-text-color" style="display: block;">Show Restart Button <span class="hero_pro_features">[PRO]</span></label> 
									<select disabled>
										<option value="" >None</option>
								...
								<div style="clear:both"></div>
								<div class="params customitemstyle" >
									<label class="customlevel" for="qchero-caption-text-color" style="display: block;">Show Pause Button <span class="hero_pro_features">[PRO]</span></label> 
									<select disabled>
										<option value="" >None</option>
...
?>
						...
						<li class="arrows">
							<div class="othersetting" style="position:relative;height: 145px;">
								<div style=" height: 100%;  width: 100%; position: absolute;opacity: 0.7;z-index: 999;background: #ddd;">
									<img src="<?php echo QCLD_sliderhero_IMAGES;?>/Screenshot_1.jpg" />
								</div>
