...
<div class="sh_bg_video">
	<iframe width="560" height="315" src="https://www.youtube.com/embed/<?php echo $params->bg_video_youtube; ?>?autoplay=1<?php echo (isset($params->video_loop)&& $params->video_loop=='1'?'&loop=1':'&loop=0'); ?>&controls=0&showinfo=0<?php echo (isset($params->video_mute)&& $params->video_mute=='1'?'&mute=1':'&mute=0'); ?>" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
</div>
<?php 
	endif;
endif;
